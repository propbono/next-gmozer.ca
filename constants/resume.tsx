...
export const EXPERIENCE = {
	title: "Experience",
	description:
		"A journey of continuous growth and impactful contributions across diverse technology companies.",
	items: [
		{
...
export const EDUCATION = {
	title: "Education",
	description:
		"A foundation of formal education combined with industry-recognized certifications.",
	items: [
		{
			institution: "AWS",
...
export const SKILLS = {
	title: "My Skills",
	description:
		"A comprehensive toolkit of modern technologies and frameworks that I've mastered to build robust, scalable applications.",
	items: [
