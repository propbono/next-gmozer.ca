...
export function ProjectShowcase() {
  ...
  return (
    <article className="container flex min-h-[80vh] justify-center py-12">
      <div className="flex w-full flex-col md:flex-row gap-8 items-center md:justify-between">
        <section className="w-full order-1 md:w-1/2 h-[450px] md:min-h-[500px] flex flex-col md:order-none" aria-labelledby="project-title">
          ...
          <h1
            id="project-title"
            className="leading-none font-bold text-5xl text-foreground group-hover:text-primary transition-all duration-500 capitalize mb-6"
          >
            {currentProject.title}
          </h1>
          <h2 className="leading-none font-medium text-2x mb-4">{currentProject.category} Project</h2>
        ...
        <section className="w-full order-2 md:w-1/2 h-full md:h-[500px]" aria-label="Project images">
